...
public class SetParameter {
	...
	public ParameterVO setParameter(@RequestParam Map<String, String> map) {
		...
		rtnParam.setKwd(common.getCheckXSS(getValue(map, "kwd", "").replaceAll("\\'", "")));
		
		// 하이라이트 키워드를 세팅한다.
		rtnParam.setHilightKwd(common.extractHighlightKwd(rtnParam.getKwd()));
